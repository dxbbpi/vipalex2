...
app.get('/callback', async (req, res) => {
  ...
  try {
    ...
    const tokenResponse = await axios.post('https://discord.com/oauth2/authorize?client_id=1367595537049845850&response_type=code&redirect_uri=https%3A%2F%2Fvipalex2.onrender.com&scope=identify',
      new URLSearchParams({
        client_id: CLIENT_ID,
